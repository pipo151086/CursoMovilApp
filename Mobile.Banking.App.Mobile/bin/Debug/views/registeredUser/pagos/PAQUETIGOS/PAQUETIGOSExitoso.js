MobileBanking_App.PAQUETIGOSExitoso = function (params) {
    "use strict";
    var currentPayment;
    if (params.id)
    ...
    var viewModel = {
        ...
        txtNuReferencia: ko.observable(currentPayment.respPago.RespuestaGenerarDebitoWeb.inputChar('-', currentPayment.respPago.RespuestaGenerarDebitoWeb.length - 1)),
