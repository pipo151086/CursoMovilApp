MobileBanking_App.TIGOSTARPagarServicio = function (params) {
    "use strict";
    var currentPayment;
    if (params.id)
    ...
    var pagarServicio = function (args) {
        ...
        if (isValid == true) {
            ...
            var requerimiento =
            {
                ...
                TipoCuenta: "0",
                //NumeroCuenta: currentPayment.respSaldo.TipoBusquedaSeleccionada,   //LO que venga de la consulta
