MobileBanking_App.CLAROPagarServicio = function (params) {
    "use strict";
    ...
    var pagarServicio = function (args) {
        ...
        if (isValid == true) {
            ...
            if (currentPayment.infoPago.tipoBusqueda == "0") {
                ...
                atribPago = "ATRCLAROPOSTPAGO"
            } else {
                atribPago = "ATRCLAROPREPAGO"
            }
            ...
            RealizarPagoServicios(accountSelected.Moneda,
                ...
                producto, function (respPago) {
                    ...
                    if (currentPayment.respPago.RespuestaGenerarDebitoWeb.length > 0) {
                        currentPayment.accountSelected = accountSelected;
                        ObtenerCuentasClientePosConsolidada(currentPayment, RedirectOnSuccess);
                    } else {
                        showSimpleMessage('Pago de Serivcios', 'No se pudo Realizar el pago', function () {
                            return;
                        }, undefined);
                    }
