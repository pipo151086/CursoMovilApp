$(function () {
    var startupView = "LandingPage"
    //"RedAgencias"//"RegCuposMax""InfoContacto"//"RegUsrPass"//"LandingPage""_1_TermCond""_3_ContactInfo""_4_Confirm"
    // "ForgottenUserName"//"RegisterUser";//"PagoServicioExitoso";//"PagoServicioConfirmacion";//"PagoServicio";//"SeleccionServicio";//"ConsultaServicio"
    ...
    const specialViews = [
        ...
        "RequestPIN", "ForgottenPasswordSecondInstance", "OlvidoPIN",
        "ForgottenUserName", "PinConfirmation", "LoadView", "LandingPage",
        "InsertPin", "GuiaUsr", "SolProductos", "CanalesAtencion", "TipoCambio",
        "_1_TermCond", "_2_CreaUsr", "_3_ContactInfo", "_4_Confirm",
        "InfoContacto", "RegPregSeg", "RegUsrPass",
        "RedAgencias",
    ];
