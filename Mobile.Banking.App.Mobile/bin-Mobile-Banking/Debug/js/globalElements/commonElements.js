...
var menuTransferencias = "<div class='has-submenu' style='display:none' id='mnTransferencias'><a class='menu-item show-submenu ' href='#'><img class='img-menu' src='./images/iconos/transferencias.png' /><em>" + CORE_TAG('Transfers') + "</em></a>" +
    ...
    // "<a class='submenu-item' id='smnTransferenciaExterna'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'></img><img class='linea'></img><em>" + CORE_TAG('ExternalTransfers') + "</em></a>" +
    ...
    //"<a class='submenu-item' id='smnBeneficiariosExternos'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'></img><em>" + CORE_TAG('ExternalBeneficiaries') + "</em></a>" +
    "</div></div>";
...
var menuTarjetas = "<div class='has-submenu' style='display:none;word-wrap: break-word;' id='mnTarjetas'><a class='menu-item show-submenu'><img class='img-menu' src='./images/iconos/trajetas.png' /><em>Tarjeta</em></a>" +
    ...
    //"<a class='submenu-item' id='smnMovimientosTarjetas'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'><em>" + CORE_TAG('MovementsDate') + "</em></a>" +
    //"<a class='submenu-item' id='smnPlanConmigo'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'></img><em>" + CORE_TAG('PlanConmigo') + "</em></a>" +
    //"<a class='submenu-item' id='smnEstadosCuentaTarjeta'style='display:none'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'></img><em>" + CORE_TAG('AccountStatus') + "</em></a></div></div>";
    "</div></div>";
...
function buildMenuClient() {
    if (SesionMovil) {
        ...
        /*
        if (jslinq(SesionMovil.ProductosCliente).any(function (el) { return el.CodigoProducto == "CRE"; })) {
            menuCredito = "<div class='has-submenu' style='display:none' id='mnCreditos'><a class='menu-item show-submenu'><img class='img-menu' src='./images/iconos/credito.png' /><em>" + CORE_TAG('Credits') + "</em></a>" +
                            "<div class='submenu'>";

            var singleProducto = jslinq(SesionMovil.PosicionConsolidada.CreditosCliente).select(function (el) { return { CodigoProducto: el.CodigoProducto, ProductoDescripcion: toTitleCase(el.ProductoDescripcion) } }).distinct().toList();

            $.each(singleProducto, function (key, value) {
                menuCredito += "<a id='smn" + value.CodigoProducto + "' class='submenu-item'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'><img class='linea'></img></img><em>" + value.ProductoDescripcion + "</em></a>";
            });

            menuCredito += "<a id='smnInformacionCreditos' class='submenu-item'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'><img class='linea'></img></img><em>" + CORE_TAG('LoansInformation') + "</em></a>";
            menuCredito += "<a id='smnEstadoCredito' class='submenu-item'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'><img class='linea'></img></img><em>" + CORE_TAG('CreditStatus') + "</em></a>";
            menuCredito += "<a id='smnPuntosCredito' class='submenu-item'><img class='bulletMenu' src='./images/iconos/bullet-pasivo.png'></img><em>" + CORE_TAG('CreditsPointPlan') + "</em></a>";
            menuCredito += "</div></div>";


            htmlLeftSideMenu = '<div style="display:block; position:relative" class="sidebar-header"><div class="sidebar-header-logo"><a></a></div><div class="overlay"></div></div>'
            + menuTusCuentas
            + menuCredito
            + menuTransferencias 
            + menuPagos
