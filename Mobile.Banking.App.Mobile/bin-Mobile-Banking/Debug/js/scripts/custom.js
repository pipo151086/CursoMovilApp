...
$( document ).ready(function() {
    ...
    $('#content').on('scroll', function () {
        ...
        if (inside_header == true) {
            ...
            //$('.area-btn-movil').removeClass('down-display');
            $('#header-fixed').removeClass('hide-header');
        } else if (passed_header == true)  {
            $('.back-to-top-badge').addClass('back-to-top-badge-visible');
            //$('.area-btn-movil').addClass('down-display');
    ...
    function dual_sidebar(){
        ...
        $('.open-left-sidebar').click(function() {
            ...
            if( snapper.state().state=="left" ){
                snapper.close();
                //areaFloat.style.display = 'block';
            } else {
                snapper.open('left');
                //areaFloat.style.display = 'none';
            }
            return false;
        });	
