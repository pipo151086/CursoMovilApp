...
(function (jQuery) {
    ...
    (function (i18next) {
        ...
        i18n.fallback = {
            wordLetterNumberCombo: 'Tu contrase&ntilde;a necesita Letras y N&#250;mero',
            wordOneNumber:'Tu contrase&ntilde;a necesita 1 N&#250;mero',
            wordOneSpecialChar:"Tu contrase&ntilde;a necesita 1 caracter especial (&#161;) (!) (#) ($) (%) (&) (/) (@) (*) (-) (+)",
            wordLength: "Tu contrase&ntilde;a es demasiado corta",
            wordMinLength: 'Tu contrase&ntilde;a es muy corta (8)',
            wordMaxLength: 'Tu contrase&ntilde;a es muy larga (12)',
            wordInvalidChar: 'Tu contrase&ntilde;a contiene carateres inv&#225;lidos',
    ...
    defaultOptions.common.maxChar = 12;
    ...
    defaultOptions.rules.specialCharClass = /[¡,!,#,$,%,&,\/,@,*,\-,+]/g;
